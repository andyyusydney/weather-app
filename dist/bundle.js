...
var _citiesWeatherReducer = __webpack_require__(71);

var _citiesWeatherReducer2 = _interopRequireDefault(_citiesWeatherReducer);
...
var store = (0, _redux.createStore)(_citiesWeatherReducer2.default, { cities: [] }, (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default)));
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(15),A=__webpack_require__(3),B=__webpack_require__(2),ca=__webpack_require__(16),da=__webpack_require__(17),ea=__webpack_require__(18),ha=__webpack_require__(19),ia=__webpack_require__(20),C=__webpack_require__(5);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(26), __webpack_require__(62)(module)))
...
var citiesWeatherReducer = function citiesWeatherReducer() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
	var action = arguments[1];
...
exports.default = citiesWeatherReducer;
...
var _CitiesWeatherList = __webpack_require__(73);

var _CitiesWeatherList2 = _interopRequireDefault(_CitiesWeatherList);
	...
	_createClass(App, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(_CitiesWeatherList2.default, null)
			);
		}
	}]);
...
var _CityWeather = __webpack_require__(74);

var _CityWeather2 = _interopRequireDefault(_CityWeather);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var CitiesWeatherList = function CitiesWeatherList(state) {
	return _react2.default.createElement(
		'table',
		{ className: 'city-weather' },
		_react2.default.createElement(
			'thead',
			{ 'class': 'city-weather__header' },
			_react2.default.createElement(
				'tr',
				{ 'class': 'city-weather__header-row' },
				_react2.default.createElement(
					'th',
					{ 'class': 'city-weather__header-item' },
					'Bus ID'
				),
				_react2.default.createElement(
					'th',
		...
		_react2.default.createElement(
			'tbody',
			{ 'class': 'city-weather__body' },
			state.cities.map(function (city) {
				return _react2.default.createElement(_CityWeather2.default, { key: city.id, name: city.name, temperature: city.main.temp, condition: city.weather[0].main });
			})
		)
	);
};
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(CitiesWeatherList);
...
var CityWeather = function CityWeather(_ref) {
	var name = _ref.name,
	    temperature = _ref.temperature,
	    condition = _ref.condition;
	return _react2.default.createElement(
		'tr',
		{ className: 'city-weather__body-row' },
		_react2.default.createElement(
			'td',
			{ className: 'city-weather__body-item' },
			name
		),
		_react2.default.createElement(
			'td',
...
CityWeather.propTypes = {
	...
	temperature: _propTypes2.default.number.isRequired,
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			{ className: 'search', onSubmit: function onSubmit(e) {
					...
					dispatch((0, _index.loadWeather)(input.value));
					input.value = "";
				} },
			_react2.default.createElement(
				'div',
				...
				_react2.default.createElement('input', { className: 'search__input', ref: function ref(node) {
						input = node;
					} })
			),
			_react2.default.createElement(
				'button',
				{ className: 'search__submit', type: 'submit' },
				'Submit'
			)
		)
	);
...
exports.setCitiesWeather = setCitiesWeather;
...
function loadWeather() {
	...
	return function (dispatch) {
		...
		var url = 'https://api.openweathermap.org/data/2.5/group?id=' + cities + '&units=metric&appid=93b01bdc94a1e05f70334a0cf1d84b77';
...
// module
exports.push([module.i, ".search__wrap {\n  display: flex;\n  margin-bottom: 10px; }\n\n.search__label {\n  flex-grow: 1; }\n\n.search__input {\n  flex-grow: 3; }\n\n.search__submit {\n  float: right;\n  margin-bottom: 20px;\n  box-shadow: 3px 3px 2px 0px rgba(0, 0, 0, 0.2); }\n", ""]);
...
// module
exports.push([module.i, ".city-weather {\n  font-size: 12px;\n  width: 100%;\n  border-collapse: collapse;\n  border: 1px solid #ddd;\n  margin-top: 8px;\n  margin-bottom: 40px; }\n  .city-weather__header {\n    background-color: #007bff;\n    text-align: left;\n    color: #fff; }\n    .city-weather__header-item {\n      padding: 8px;\n      border-left: 1px solid #dddddd;\n      border-right: 1px solid #dddddd; }\n  .city-weather__body-row:nth-child(odd) {\n    background: #d9edf7; }\n  .city-weather__body-item {\n    padding: 8px;\n    border-left: 1px solid #dddddd;\n    border-right: 1px solid #dddddd; }\n  .city-weather .early {\n    color: red; }\n  .city-weather .late {\n    color: blue; }\n  .city-weather .on-time {\n    color: green; }\n", ""]);
